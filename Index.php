...
<body>
    ...
    <section class="section-hero">
        <div class="container hero-box">
          ...
          <div class="btn-group">
            ...
            <button class="btn btn__secondary"><a href="course.php">Our services</a></button>
          </div>
        </div>
      </section>
      ...
      <section class="section-offer" id="offer">
        <div class="offer-box">
          <div class="offer" data-aos="fade-up">
            ...
            <button class="btn btn__primary" href="course"><a href="course.php">Go to Courses</a></button>
          </div>
    ...
    <div class="col col-3">
        <div  class="services">
            ...
            <h2> 100+ videos </h2>
        <h4> Variety of videos to choose from </h4>
      </div>
    </div>
